...
public class Reporting extends MainClass implements IReporter {
	...
	/*
	 * This class is for the implementation of TestNG listeners. It will also
	 * generating reports in the console at the end of test execution.
	 */

	// Method to generate reports and update status of test cases as passed and
	// failed.
	@Override
	public void generateReport(List<XmlSuite> xmlSuites, List<ISuite> suites,
		...
		for (ISuite isuite : suites) {
			...
			for (String key : keys) {
				...
				Collection<ITestNGMethod> passedMethods = resultMap
				        .getAllMethods();
				...
				Collection<ITestNGMethod> failedMethods = fresultMap
				        .getAllMethods();
